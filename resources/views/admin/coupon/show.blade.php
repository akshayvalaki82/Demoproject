            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/coupon/' . $coupon['id'] . '/edit') }}" title="Edit configuration"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Conf Key </th><td> {{ $coupon['code'] }} </td></tr><tr><th> Conf Value </th><td> {{ $coupon['percent_off'] }} </td></tr>
                                </tbody>
                            </table>
                        </div>
